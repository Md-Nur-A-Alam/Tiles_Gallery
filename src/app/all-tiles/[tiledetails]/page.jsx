  ...
  if (!tile) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAFAF8] gap-4">
        ...
        <Link href="/all-tiles" className="text-[#BC6C4D] underline text-sm">← Back to all tiles</Link>
      </div>
    );
  }
  ...
  return (
    ...
    <div className="bg-[#FAFAF8] min-h-screen pt-12 pb-24">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        {/* Back Link */}
        <Link href="/all-tiles" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#BC6C4D] transition mb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
              ...
              <div className="grid grid-cols-4 gap-3">
                {tile.images.map((img, idx) => (
                  <div
                    ...
                    className={`relative aspect-square cursor-pointer border-2 rounded-sm overflow-hidden transition-all ${mainImage === img ? 'border-[#BC6C4D]' : 'border-transparent hover:border-gray-200'}`}
                  >
          ...
          <div className="flex flex-col">
            <div className="flex justify-between items-start mb-2">
              <span className="text-[#BC6C4D] text-[10px] uppercase tracking-[0.2em] font-bold">
                {tile.collection}
              </span>
            ...
            <div className="border-t border-b border-gray-100 py-6 mb-8 flex justify-between items-baseline">
              <span className="text-2xl text-[#BC6C4D] font-semibold">${tile.price?.toFixed(2)}</span>
            ...
            <div className="space-y-3 mb-8">
              <button className="w-full bg-[#BC6C4D] text-white py-4 text-xs font-bold uppercase tracking-widest hover:bg-[#6F3710] transition-colors">
                Request Sample
              </button>
        ...
        <div className="border-t border-gray-100 pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-gray-100 p-8 hover:shadow-sm transition-shadow">
              <h3 className="text-[#BC6C4D] text-[11px] font-bold uppercase tracking-widest mb-4">Usage Range</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
                Suitable for interior floors, walls, and covered exterior spaces. High resistance to moisture and thermal shock.
              </p>
            </div>
            <div className="border border-gray-100 p-8 hover:shadow-sm transition-shadow">
              <h3 className="text-[#BC6C4D] text-[11px] font-bold uppercase tracking-widest mb-4">Installation</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
                Standard thin-set mortar installation. Recommended grout joint: 2mm for a seamless architectural look.
              </p>
            </div>
            <div className="border border-gray-100 p-8 hover:shadow-sm transition-shadow">
              <h3 className="text-[#BC6C4D] text-[11px] font-bold uppercase tracking-widest mb-4">Maintenance</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
